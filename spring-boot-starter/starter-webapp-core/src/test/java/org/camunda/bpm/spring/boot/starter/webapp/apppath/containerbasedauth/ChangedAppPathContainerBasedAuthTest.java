...
import static org.camunda.bpm.spring.boot.starter.webapp.apppath.containerbasedauth.ChangedAppPathContainerBasedAuthTest.MY_APP_PATH;
...
@TestPropertySource(properties = {
    "camunda.bpm.webapp.applicationPath=" + MY_APP_PATH
})
public class ChangedAppPathContainerBasedAuthTest {
  ...
  @Test
  public void shouldCheckContainerBasedAuthFilterAvailable() throws InterruptedException {
    // given
