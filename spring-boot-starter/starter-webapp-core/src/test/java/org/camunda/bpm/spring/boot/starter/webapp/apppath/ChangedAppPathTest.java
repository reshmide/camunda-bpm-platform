...
import static org.camunda.bpm.spring.boot.starter.webapp.apppath.ChangedAppPathTest.MY_APP_PATH;
...
public class ChangedAppPathTest {
  ...
  public void shouldCheckPresenceOfCacheControlFilter() {
    ...
    // when
    headerRule.performRequest("http://localhost:" + port + MY_APP_PATH +
        "/app/admin/styles/styles.css");

    // then
    assertThat(headerRule.getHeader("Cache-Control")).isEqualTo("no-cache");
  }
